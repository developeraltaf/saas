...
class DeleteEventcategory extends React.Component {
  constructor(props) {
    super(props)
  ...
  deleteData(id) {
    ...
    const url = REACT_APP_RESTAPI + 'modules/event/eventcategory.php'
    ...
    axios({
      ...
      .then((response) => {
        ...
        if (response.data.success === true) {
          ...
          setTimeout(() => {
            this.props.history.push('eventcategories')
          }, 2000)
        }
      })
            ...
            <Col xs={12} md={12}>
              <div className="page-title">
                <div className="float-left">
                  <h1 className="title">Delete Event category</h1>
                </div>
              </div>
                    ...
                    <div className="content-body">
                      <div className="row">
                        <div className="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-8">
                          Deleting Event category ID: {this.state.id}
                        </div>
                      </div>
                    </div>
                  </section>
