...
//import { Eventcategoryslist } from 'components';
    ...
    if (action === 'submit') {
      ...
      if (!checkmode['allow']) {
        ...
        this.props.history.push(
          'delete-eventcategory?id=' + this.state.deleteid,
        )
      }
    }
    this._isMounted &&
    ...
    const header = [
      ...
      },
      {
        ...
        cell: (row) => (
          <p>
            <a
              href={'add-eventcategory?id=' + row.id}
              ...
              <Col xs={12} md={12}>
                <div className="page-title">
                  <div className="float-left">
                    <h1 className="title">Event Categories</h1>
                  </div>
                </div>
                ...
                <div className="col-xl-12">
                  <section className="box ">
                    <header className="panel_header">
                      <h2 className="title float-left">All Event Categories</h2>
                    </header>
                    <div className="content-body">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <ModalBody>
                            Are you sure you want to delete event category:{' '}
