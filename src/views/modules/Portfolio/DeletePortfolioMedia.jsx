...
class DeletePortfolioMedia extends React.Component {
  constructor(props) {
    super(props)
            ...
            <Col xs={12} md={12}>
              <div className="page-title">
                <div className="float-left">
                  <h1 className="title">Delete Portfolio Media</h1>
                </div>
              </div>
                    ...
                    <div className="content-body">
                      <div className="row">
                        <div className="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-8">
                          Deleting Portfolio Media ID: {this.state.id}
                        </div>
                      </div>
                    </div>
                  </section>
...
export default DeletePortfolioMedia
