...
class PortfolioMedia extends React.Component {
  constructor(props) {
    super(props)
    ...
    if (action === 'submit') {
      ...
      if (!checkmode['allow']) {
        ...
        this.props.history.push(
          'delete-portfoliomedia?id=' + this.state.deleteid,
        )
      }
    }
    this._isMounted &&
  ...
  render() {
    ...
    const header = [
      ...
      { title: 'Image', prop: 'name', sortable: false, filterable: false },
      ...
      },
      {
        ...
        cell: (row) => (
          <p>
            <a
              href={'add-portfoliomedia?id=' + row.id}
              ...
              <Col xs={12} md={12}>
                <div className="page-title">
                  <div className="float-left">
                    <h1 className="title">Portfolio Media</h1>
                  </div>
                </div>
                ...
                <div className="col-xl-12">
                  <section className="box ">
                    <header className="panel_header">
                      <h2 className="title float-left">All Portfolio Media</h2>
                    </header>
                    <div className="content-body">
                      ...
                      <div>
                        ...
                        >
                          ...
                          <ModalBody>
                            Are you sure you want to delete Portfolio Media ID:{' '}
                            {this.state.deleteid} ?
                          </ModalBody>
                          <ModalFooter>
                            <Button
