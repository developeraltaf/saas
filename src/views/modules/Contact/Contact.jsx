  ...
  toggle(e) {
    ...
    if (action === 'submit') {
      ...
      if (!checkmode['allow']) {
        ...
        this.props.history.push('delete-contact?id=' + this.state.deleteid)
      }
    }
    this._isMounted &&
      this.setState({
                ...
                <div className="col-xl-12">
                  <section className="box ">
                    <header className="panel_header">
                      <h2 className="title float-left">All Contacts</h2>
                    </header>
