...
class DeleteMailcategory extends React.Component {
  constructor(props) {
    super(props)
            ...
            <Col xs={12} md={12}>
              <div className="page-title">
                <div className="float-left">
                  <h1 className="title">Delete Mail category</h1>
                </div>
              </div>
                    ...
                    <div className="content-body">
                      <div className="row">
                        <div className="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-8">
                          Deleting Mail category ID: {this.state.id}
                        </div>
                      </div>
                    </div>
                  </section>
...
export default DeleteMailcategory
