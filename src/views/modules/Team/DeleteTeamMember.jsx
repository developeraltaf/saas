...
class DeleteTeamMember extends React.Component {
  constructor(props) {
    super(props)
  ...
  deleteData(id) {
    ...
    const url = REACT_APP_RESTAPI + 'modules/team/team.php'
            ...
            <Col xs={12} md={12}>
              <div className="page-title">
                <div className="float-left">
                  <h1 className="title">Delete Member</h1>
                </div>
              </div>
                    ...
                    <div className="content-body">
                      <div className="row">
                        <div className="col-12 col-sm-12 col-md-10 col-lg-10 col-xl-8">
                          Deleting Team Member ID: {this.state.id}
                        </div>
                      </div>
                    </div>
                  </section>
